          ...
          <DialogHeader>
            <div className="flex gap-3 items-center">
              <div className="p-2 rounded-full bg-purple-500/10">
                <Chrome size={18} className="text-purple-500" />
              </div>
              <DialogTitle>Add SearchThing to Chrome</DialogTitle>
            </div>
            <DialogDescription>
              Enhance your browsing experience with our Chrome extensions.
            </DialogDescription>
          </DialogHeader>
          ...
          <Tabs defaultValue="search" className="mb-4">
            ...
            <TabsContent value="manual" className="mt-4">
              <div className="space-y-2">
                <h3 className="text-lg font-medium">Manual Setup / Non Chrome Browsers</h3>
